...
class AGlooCannonCharacter;

UCLASS(Blueprintable, BlueprintType, ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class GLOOCANNON_API UTP_WeaponComponent : public USkeletalMeshComponent
{
	GENERATED_BODY()
...
public:
	...
	void AttachWeapon(AGlooCannonCharacter* TargetCharacter);
...
private:
	...
	AGlooCannonCharacter* Character;
};
